...
class RegistrationController extends AbstractController
{
        ...
        JWTService $jwt): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $mail->send(
                ...
                $user->getEmail(),
                'Activation de votre compte sur Sk8',
                'register',
                compact('user', 'token')
            );
    ...
    public function verifyUser($token, JWTService $jwt, UtilisateurRepository $userRepository, EntityManagerInterface $em): Response
    {
